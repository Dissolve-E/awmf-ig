...
| Draft as of 2026-08-06 | *Computable Name*:AWMFGuidelineRegistryRecord |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.awmf.org/awmf.ig/StructureDefinition/ext-first-publication-date"]
      }],
      "mustSupport" : true
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.awmf.org/awmf.ig/StructureDefinition/ext-submission-date"]
      }],
      "mustSupport" : true
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.awmf.org/awmf.ig/StructureDefinition/ext-consultation-period"]
      }],
      "mustSupport" : true
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.awmf.org/awmf.ig/StructureDefinition/ext-planned-completion-date"]
      }],
      "mustSupport" : true
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.awmf.org/awmf.ig/StructureDefinition/ext-registration-date"]
      }],
      "mustSupport" : true
    },
    {
      "id" : "Composition.extension:guidelineLastReviewDate",
      "path" : "Composition.extension",
      "sliceName" : "guidelineLastReviewDate",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.awmf.org/awmf.ig/StructureDefinition/ext-composition-last-review-date"]
      }],
      "mustSupport" : true
    },
    {
      "id" : "Composition.extension:guidelineApprovalDate",
      "path" : "Composition.extension",
      "sliceName" : "guidelineApprovalDate",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.awmf.org/awmf.ig/StructureDefinition/ext-composition-approval-date"]
      }],
      "mustSupport" : true
    },
    {
      "id" : "Composition.extension:guidelineEffectivePeriod",
      "path" : "Composition.extension",
      "sliceName" : "guidelineEffectivePeriod",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.awmf.org/awmf.ig/StructureDefinition/ext-composition-effective-period"]
      }],
      "mustSupport" : true
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://fhir.awmf.org/awmf.ig/StructureDefinition/guideline-author-role",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.awmf.org/awmf.ig/StructureDefinition/ext-guideline-author-role"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.awmf.org/awmf.ig/StructureDefinition/ext-relates-to-label"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.awmf.org/awmf.ig/StructureDefinition/ext-section-language"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.awmf.org/awmf.ig/StructureDefinition/ext-section-coding"]
      }]
    },
    {
    ...
    {
      "id" : "Composition.section:summary.section:careSetting.section:encounterType",
      "path" : "Composition.section.section.section",
    ...
    {
      "id" : "Composition.section:summary.section:careSetting.section:encounterType.extension",
      "path" : "Composition.section.section.section.extension",
      "slicing" : {
        "discriminator" : [{
          "type" : "value",
    ...
    {
      "id" : "Composition.section:summary.section:careSetting.section:encounterType.extension:value",
      "path" : "Composition.section.section.section.extension",
      "sliceName" : "value",
      "min" : 0,
      "max" : "*",
    ...
    {
      "id" : "Composition.section:summary.section:careSetting.section:encounterType.extension:value.value[x]",
    ...
    {
      "id" : "Composition.section:summary.section:careSetting.section:encounterType.code",
      "path" : "Composition.section.section.section.code",
      "min" : 1,
      "patternCodeableConcept" : {
        "coding" : [{
    ...
    {
      "id" : "Composition.section:summary.section:careSetting.section:encounterType.section",
      "path" : "Composition.section.section.section.section",
      "slicing" : {
        "discriminator" : [{
          "type" : "value",
    ...
    {
      "id" : "Composition.section:summary.section:careSetting.section:encounterType.section:language",
      "path" : "Composition.section.section.section.section",
      "sliceName" : "language",
      "min" : 0,
      "max" : "*",
    ...
    {
      "id" : "Composition.section:summary.section:careSetting.section:encounterType.section:language.extension",
    ...
    {
      "id" : "Composition.section:summary.section:careSetting.section:encounterType.section:language.extension:language",
      "path" : "Composition.section.section.section.section.extension",
      "sliceName" : "language",
      "min" : 1,
      "max" : "1",
    ...
    {
      "id" : "Composition.section:summary.section:careSetting.section:encounterType.section:language.code",
    ...
    {
      "id" : "Composition.section:summary.section:careSetting.section:encounterType.section:language.code.coding",
    ...
    {
      "id" : "Composition.section:summary.section:careSetting.section:encounterType.section:language.section",
      "path" : "Composition.section.section.section.section.section",
      "max" : "0"
    },
    {
      "id" : "Composition.section:summary.section:careSetting.section:encounterType.section:text",
      "path" : "Composition.section.section.section.section",
      "sliceName" : "text",
      "min" : 0,
      "max" : "*",
    ...
    {
      "id" : "Composition.section:summary.section:careSetting.section:encounterType.section:text.code",
      "path" : "Composition.section.section.section.section.code",
      "min" : 1,
      "patternCodeableConcept" : {
        "coding" : [{
    ...
    {
      "id" : "Composition.section:summary.section:careSetting.section:encounterType.section:text.code.coding",
      "path" : "Composition.section.section.section.section.code.coding",
      "min" : 1,
      "max" : "1",
      "patternCoding" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.awmf.org/awmf.ig/StructureDefinition/ext-section-keyword"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://fhir.awmf.org/awmf.ig/StructureDefinition/guideline-attachment"]
      }],
      "mustSupport" : true
    },
    {
