...
| Draft as of 2026-08-06 | *Computable Name*:GuidelineAuthorRole |
...
* Examples for this Profile: [PractitionerRole/DirkHellwigDGNFor018-038](PractitionerRole-DirkHellwigDGNFor018-038.md), [PractitionerRole/GuidelineAuthorRoleExample](PractitionerRole-GuidelineAuthorRoleExample.md), [PractitionerRole/JessicaRademacherDGPFor020-013](PractitionerRole-JessicaRademacherDGPFor020-013.md), [PractitionerRole/LaleUmutluDRGFor018-038](PractitionerRole-LaleUmutluDRGFor018-038.md)... Show 2 more, [PractitionerRole/ThorstenPersigehlDRGFor018-038](PractitionerRole-ThorstenPersigehlDRGFor018-038.md) and [PractitionerRole/UlrichDuehrsenDGIMFor018-038](PractitionerRole-UlrichDuehrsenDGIMFor018-038.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/awmf.ig|current/StructureDefinition/StructureDefinition-guideline-author-role.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://fhir.awmf.org/awmf.ig/StructureDefinition/guideline-author"]
      }]
    }]
  }
}
