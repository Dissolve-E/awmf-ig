...
| [Composition Approval Date](StructureDefinition-ext-composition-approval-date.md) | The date on which the composition content was approved by the publisher. Approval happens once when the content is officially approved for usage. |
| [Composition Effective Period](StructureDefinition-ext-composition-effective-period.md) | The period during which the composition content was or is planned to be effective. |
| [Composition Last Review Date](StructureDefinition-ext-composition-last-review-date.md) | The date on which the composition content was last reviewed. Review happens periodically after that, but doesn't change the original approval date. |
...
| [DEGRO](Organization-DEGRO.md) | Deutsche Gesellschaft für Radioonkologie e.V. (DEGRO) |
| [DEGUM](Organization-DEGUM.md) | Deutsche Gesellschaft für Ultraschall in der Medizin e.V. (DEGUM) |
| [DGA](Organization-DGA.md) | Deutsche Gesellschaft für Andrologie e.V. (DGA) |
...
| [DGE-BV](Organization-DGEBV.md) | Deutsche Gesellschaft für Endoskopie und Bildgebende Verfahren e.V. (DGE-BV) |
| [DGG](Organization-DGG.md) | Deutsche Gesellschaft für Geriatrie e.V. (DGG) |
| [DGGG](Organization-DGGG.md) | Deutsche Gesellschaft für Gynäkologie und Geburtshilfe e.V. (DGGG) |
| [DGHM](Organization-DGHM.md) | Deutsche Gesellschaft für Hygiene und Mikrobiologie e.V. (DGHM) |
| [DGHO](Organization-DGHO.md) | Deutsche Gesellschaft für Hämatologie und Medizinische Onkologie e.V. (DGHO) |
...
| [DGN](Organization-DGN.md) | Deutsche Gesellschaft für Nuklearmedizin e.V. (DGN) |
| [DGP](Organization-DGP.md) | Deutsche Gesellschaft für Pneumologie und Beatmungsmedizin e.V. (DGP) |
| [DGP (Palliativmedizin)](Organization-DGPalliativ.md) | Deutsche Gesellschaft für Palliativmedizin e.V. (DGP) |
| [DGP (Pathologie)](Organization-DGPathologie.md) | Deutsche Gesellschaft für Pathologie e.V. (DGP) |
...
| [DGU](Organization-DGU.md) | Deutsche Gesellschaft für Urologie e.V. (DGU) |
...
| [Dirk Hellwig](Practitioner-DirkHellwig.md) | Dirk Hellwig |
| [Dirk Hellwig for DGN in the context of 018-038](PractitionerRole-DirkHellwigDGNFor018-038.md) | Dirk Hellwig for DGN in the context of 018-038 |
| [EbM-Netzwerk](Organization-EbMNetzwerk.md) | Netzwerk Evidenzbasierte Medizin e.V. (EbM-Netzwerk) |
| [Evidence Assessment: Knochenmarkbiopsie - Ereignisfreies Überleben](ArtifactAssessment-EvA-BoneMarrowBiopsy-EFS.md) | Evidenzsicherheit für Knochenmarkbiopsie vs. PET/CT-Staging: Ereignisfreies Überleben |
| [Evidence Assessment: Knochenmarkbiopsie - Gesamtüberleben](ArtifactAssessment-EvA-BoneMarrowBiopsy-OS.md) | Evidenzsicherheit für Knochenmarkbiopsie vs. PET/CT-Staging: Gesamtüberleben |
| [Evidence Assessment: Knochenmarkbiopsie - Negativer Vorhersagewert (Stadieneinteilung)](ArtifactAssessment-EvA-BoneMarrowBiopsy-NPV.md) | Evidenzsicherheit für Knochenmarkbiopsie vs. PET/CT-Staging: Negativer Vorhersagewert (Stadieneinteilung) |
| [Evidence Assessment: Knochenmarkbiopsie - Positiver Vorhersagewert (Stadieneinteilung)](ArtifactAssessment-EvA-BoneMarrowBiopsy-PPV.md) | Evidenzsicherheit für Knochenmarkbiopsie vs. PET/CT-Staging: Positiver Vorhersagewert (Stadieneinteilung) |
| [Evidence Assessment: Knochenmarkbiopsie - Progressionsfreies Überleben](ArtifactAssessment-EvA-BoneMarrowBiopsy-PFS.md) | Evidenzsicherheit für Knochenmarkbiopsie vs. PET/CT-Staging: Progressionsfreies Überleben |
| [Evidence Assessment: Knochenmarkbiopsie - Sensitivität (Stadieneinteilung)](ArtifactAssessment-EvA-BoneMarrowBiopsy-Sensitivity.md) | Evidenzsicherheit für Knochenmarkbiopsie vs. PET/CT-Staging: Sensitivität (Stadieneinteilung) |
| [Evidence Assessment: Knochenmarkbiopsie - Spezifität (Stadieneinteilung)](ArtifactAssessment-EvA-BoneMarrowBiopsy-Specificity.md) | Evidenzsicherheit für Knochenmarkbiopsie vs. PET/CT-Staging: Spezifität (Stadieneinteilung) |
| [Evidence Assessment: Knochenmarkbiopsie - Stadieneinteilung](ArtifactAssessment-EvA-BoneMarrowBiopsy-Staging.md) | Evidenzsicherheit für Knochenmarkbiopsie vs. PET/CT-Staging: Stadieneinteilung |
...
| [Evidence: Knochenmarkbiopsie - Ereignisfreies Überleben](Evidence-Evidence-BoneMarrowBiopsy-EFS.md) | Evidenz zum Einfluss von Knochenmarkbiopsie vs. PET/CT-Staging auf das ereignisfreie Überleben |
| [Evidence: Knochenmarkbiopsie - Gesamtüberleben](Evidence-Evidence-BoneMarrowBiopsy-OS.md) | Evidenz zum Einfluss von Knochenmarkbiopsie vs. PET/CT-Staging auf das Gesamtüberleben |
| [Evidence: Knochenmarkbiopsie - Negativer Vorhersagewert (Stadieneinteilung)](Evidence-Evidence-BoneMarrowBiopsy-NPV.md) | Evidenz zum negativen Vorhersagewert von PET/CT vs. Knochenmarkbiopsie für die Stadieneinteilung |
| [Evidence: Knochenmarkbiopsie - Positiver Vorhersagewert (Stadieneinteilung)](Evidence-Evidence-BoneMarrowBiopsy-PPV.md) | Evidenz zum positiven Vorhersagewert von PET/CT vs. Knochenmarkbiopsie für die Stadieneinteilung |
| [Evidence: Knochenmarkbiopsie - Progressionsfreies Überleben](Evidence-Evidence-BoneMarrowBiopsy-PFS.md) | Evidenz zum Einfluss von Knochenmarkbiopsie vs. PET/CT-Staging auf das progressionsfreie Überleben |
| [Evidence: Knochenmarkbiopsie - Sensitivität (Stadieneinteilung)](Evidence-Evidence-BoneMarrowBiopsy-Sensitivity.md) | Evidenz zur Sensitivität von PET/CT vs. Knochenmarkbiopsie für die Stadieneinteilung |
| [Evidence: Knochenmarkbiopsie - Spezifität (Stadieneinteilung)](Evidence-Evidence-BoneMarrowBiopsy-Specificity.md) | Evidenz zur Spezifität von PET/CT vs. Knochenmarkbiopsie für die Stadieneinteilung |
| [Evidence: Knochenmarkbiopsie - Stadieneinteilung](Evidence-Evidence-BoneMarrowBiopsy-Staging.md) | Evidenz zur Genauigkeit von PET/CT vs. Knochenmarkbiopsie für die Stadieneinteilung |
...
| [Lale Umutlu](Practitioner-LaleUmutlu.md) | Lale Umutlu |
| [Lale Umutlu for DRG in the context of 018-038](PractitionerRole-LaleUmutluDRGFor018-038.md) | Lale Umutlu for DRG in the context of 018-038 |
...
| [Outcome: Ereignisfreies Überleben](Group-Outcome-EventFreeSurvival.md) | Endpunkt: Ereignisfreies Überleben |
| [Outcome: Gesamtüberleben](Group-Outcome-OverallSurvival.md) | Endpunkt: Gesamtüberleben |
| [Outcome: Negativer Vorhersagewert (Stadieneinteilung)](Group-Outcome-Staging-NPV.md) | Endpunkt: Negativer Vorhersagewert (Stadieneinteilung) |
| [Outcome: Positiver Vorhersagewert (Stadieneinteilung)](Group-Outcome-Staging-PPV.md) | Endpunkt: Positiver Vorhersagewert (Stadieneinteilung) |
| [Outcome: Progressionsfreies Überleben](Group-Outcome-ProgressionFreeSurvival.md) | Endpunkt: Progressionsfreies Überleben |
| [Outcome: Sensitivität (Stadieneinteilung)](Group-Outcome-Staging-Sensitivity.md) | Endpunkt: Sensitivität (Stadieneinteilung) |
| [Outcome: Spezifität (Stadieneinteilung)](Group-Outcome-Staging-Specificity.md) | Endpunkt: Spezifität (Stadieneinteilung) |
| [Outcome: Stadieneinteilung](Group-Outcome-Staging.md) | Endpunkt: Stadieneinteilung |
...
| [RecommendationAgainstBoneMarrowBiopsy-Justification](ArtifactAssessment-RecommendationAgainstBoneMarrowBiopsy-Justification.md) | Begründung für Empfehlung 5.13: Situationen mit Empfehlungen gegen eine Knochenmarkbiopsie |
...
| [S3-Leitlinie Diagnostik, Therapie und Nachsorge für erwachsene Patient*innen mit einem diffusen großzelligen B-Zell-Lymphom und verwandten Entitäten](Composition-DiffuseLargeBCellLymphomaGuideline.md) | S3-Leitlinie Diagnostik, Therapie und Nachsorge für erwachsene Patient*innen mit einem diffusen großzelligen B-Zell-Lymphom (DLBCL) und verwandten Entitäten |
| [S3-Leitlinie Diagnostik, Therapie und Nachsorge für erwachsene Patient*innen mit einem diffusen großzelligen B-Zell-Lymphom und verwandten Entitäten](Composition-DiffuseLargeBCellLymphomaGuidelineRecord.md) | S3-Leitlinie Diagnostik, Therapie und Nachsorge für erwachsene Patient*innen mit einem diffusen großzelligen B-Zell-Lymphom (DLBCL) und verwandten Entitäten |
...
| [Situationen mit Empfehlungen gegen eine Knochenmarkbiopsie](Composition-RecommendationAgainstBoneMarrowBiopsy.md) | Empfehlung 5.13: Situationen mit Empfehlungen gegen eine Knochenmarkbiopsie beim PET/CT-gestützten Staging des DLBCL. |
...
| [Thorsten Persigehl](Practitioner-ThorstenPersigehl.md) | Thorsten Persigehl |
| [Thorsten Persigehl for DRG in the context of 018-038](PractitionerRole-ThorstenPersigehlDRGFor018-038.md) | Thorsten Persigehl for DRG in the context of 018-038 |
| [Ulrich Dührsen](Practitioner-UlrichDuehrsen.md) | Ulrich Dührsen |
| [Ulrich Dührsen for DGIM in the context of 018-038](PractitionerRole-UlrichDuehrsenDGIMFor018-038.md) | Ulrich Dührsen for DGIM in the context of 018-038 |
