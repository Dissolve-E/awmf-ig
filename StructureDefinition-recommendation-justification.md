...
| Draft as of 2026-08-06 | *Computable Name*:RecommendationJustification |
...
* Examples for this Profile: [ArtifactAssessment/RecommendationAgainstBoneMarrowBiopsy-Justification](ArtifactAssessment-RecommendationAgainstBoneMarrowBiopsy-Justification.md), [ArtifactAssessment/RecommendationHAPDiagnosis-A-Justification](ArtifactAssessment-RecommendationHAPDiagnosis-A-Justification.md), [ArtifactAssessment/RecommendationHAPDiagnosis-B-Justification](ArtifactAssessment-RecommendationHAPDiagnosis-B-Justification.md) and [ArtifactAssessment/RecommendationMultiplexPCRDiagnostic-Justification](ArtifactAssessment-RecommendationMultiplexPCRDiagnostic-Justification.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/awmf.ig|current/StructureDefinition/StructureDefinition-recommendation-justification.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://fhir.awmf.org/awmf.ig/StructureDefinition/conceptual-cohort-definition-outcome",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://fhir.awmf.org/awmf.ig/StructureDefinition/evidence-assessment"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://hl7.org/fhir/uv/ebm/StructureDefinition/systematic-review"]
      }]
    },
    {
