...
| Draft as of 2026-08-06 | *Computable Name*:FirstPublicationDate |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/awmf.ig|current/StructureDefinition/StructureDefinition-ext-first-publication-date.json)
