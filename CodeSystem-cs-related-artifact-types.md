...
| Active as of 2026-08-06 | *Computable Name*:RelatedArtifactTypes |
...
```json
{
  ...
  },
  {
    ...
    "definition" : "Supplementary material, derived from or related to the guideline.",
    "_definition" : {
      "extension" : [{
        "extension" : [{
          "url" : "lang",
        ...
        {
          "url" : "content",
          "valueString" : "Zusätzliche Materialien, die auf der Leitlinie basieren oder mit ihr in Zusammenhang stehen."
        }],
        "url" : "http://hl7.org/fhir/StructureDefinition/translation"
      }]
    },
    "designation" : [{
      "language" : "de",
      "value" : "Verwandte Information"
    }]
  },
  {
    "code" : "other",
    "display" : "Other",
    "definition" : "A different type of information or material",
    "_definition" : {
      "extension" : [{
        "extension" : [{
          "url" : "lang",
        ...
        {
          "url" : "content",
          "valueString" : "Sonstige Informationen oder Materialien."
        }],
        "url" : "http://hl7.org/fhir/StructureDefinition/translation"
      }]
    },
