# Test: Release Type If Registered (Should Pass) - Dissolve-E: AWMF Guideline Registry v0.2.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Test: Release Type If Registered (Should Pass)**

## Example Composition: Test: Release Type If Registered (Should Pass)
...
```json
{
  ...
  "id" : "RR-TestTestInvRequireReleaseTypeIfRegistered-SHOULD-PASS",
  "meta" : {
    "profile" : [
