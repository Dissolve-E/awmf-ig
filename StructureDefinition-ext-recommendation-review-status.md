...
| Draft as of 2026-08-06 | *Computable Name*:RecommendationReviewStatus |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/awmf.ig|current/StructureDefinition/StructureDefinition-ext-recommendation-review-status.json)
