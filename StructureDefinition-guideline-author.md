...
| Draft as of 2026-08-06 | *Computable Name*:GuidelineAuthor |
...
* Examples for this Profile: [Practitioner/DirkHellwig](Practitioner-DirkHellwig.md), [Practitioner/GuidelineAuthorExample](Practitioner-GuidelineAuthorExample.md), [Practitioner/JessicaRademacher](Practitioner-JessicaRademacher.md), [Practitioner/LaleUmutlu](Practitioner-LaleUmutlu.md)... Show 2 more, [Practitioner/ThorstenPersigehl](Practitioner-ThorstenPersigehl.md) and [Practitioner/UlrichDuehrsen](Practitioner-UlrichDuehrsen.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/awmf.ig|current/StructureDefinition/StructureDefinition-guideline-author.json)
