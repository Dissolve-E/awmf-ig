# Test: Two Registrant Authors (Should Fail) - Dissolve-E: AWMF Guideline Registry v0.2.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Test: Two Registrant Authors (Should Fail)**

## Example Composition: Test: Two Registrant Authors (Should Fail)
...
```json
{
  ...
  "id" : "RR-TestTestInvAuthorRegistSingleton-TwoRegistrants-SHOULD-FAIL",
  "meta" : {
    "profile" : [
