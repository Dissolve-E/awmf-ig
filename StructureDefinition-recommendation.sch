...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile Recommendation
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Composition">
      ...
      <sch:assert test="count(f:extension[@url = 'http://fhir.awmf.org/awmf.ig/StructureDefinition/ext-recommendation-review-status']) &lt;= 1">extension with URL = 'http://fhir.awmf.org/awmf.ig/StructureDefinition/ext-recommendation-review-status': maximum cardinality of 'extension' is 1</sch:assert>
