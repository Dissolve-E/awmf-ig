...
## ValueSet: Target Patient Group 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.awmf.org/awmf.ig/ValueSet/vs-target-patient-group | *Version*:0.2.0 |
| Draft as of 2026-01-29 | *Computable Name*:TargetPatientGroupVS |
...
```json
{
  ...
  "url" : "http://fhir.awmf.org/awmf.ig/ValueSet/vs-target-patient-group",
  "version" : "0.2.0",
  "name" : "TargetPatientGroupVS",
