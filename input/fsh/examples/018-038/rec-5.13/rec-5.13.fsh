...
* section[recommendationStatement]
  * section[language]
    * extension[language].valueCode = #de
    // removed due to narrative constraint failure (txt-1) - see below
    //    Constraint failed: txt-1: 'The narrative SHALL contain only the basic html formatting elements and attributes described in chapters 7-11 (except section 4 of chapter 9) and 15 of the HTML 4.0 standard, <a> elements (either name or href), images and internally contained style attributes, and SHALL contain some non-whitespace characters (htmlChecks())' (defined in http://hl7.org/fhir/StructureDefinition/Narrative) 
    //  	Invalid attribute name in the XHTML ('data-linktype' on 'a')
    //  	Invalid attribute name in the XHTML ('data-val' on 'a')
    ...
    * insert narrative([[<div>\n<p>Bei Einsatz der PET/CT zur Stadieneinteilung soll bei kurativem Konzept in folgenden Situationen auf eine Knochenmarkbiopsie verzichtet werden:</p>\n<ul>\n<li>Nachweis einer Knochenmarkbeteiligung durch die PET/CT</li>\n<li>Fortgeschrittenes Ausbreitungsstadium (Ann Arbor-Stadium III oder IV; <a>s. 5.2.3.1</a>)</li>\n<li>Limitiertes Ausbreitungsstadium (Ann Arbor-Stadium I oder II) mit \u201abulky disease\u2018 (<a>s. 5.3.2.1.</a>) und/oder \u2265\u00a01 ung\u00fcnstigem Faktor des altersadjustierten \u201aInternationalen Prognostischen Index\u2018 (IPI) (s. <a>5.3.1.2</a>).</li>\n</ul>\n</div>]])
