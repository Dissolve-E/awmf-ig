...
## ValueSet: Guideline Release Type 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.awmf.org/awmf.ig/ValueSet/vs-guideline-release-type | *Version*:0.2.0 |
| Draft as of 2026-01-29 | *Computable Name*:GuidelinesReleaseTypeVS |
...
```json
{
  ...
  "url" : "http://fhir.awmf.org/awmf.ig/ValueSet/vs-guideline-release-type",
  "version" : "0.2.0",
  "name" : "GuidelinesReleaseTypeVS",
