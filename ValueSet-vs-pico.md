...
## ValueSet: PICO related terms 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.awmf.org/awmf.ig/ValueSet/vs-pico | *Version*:0.2.0 |
| Draft as of 2026-01-29 | *Computable Name*:PICOVS |
...
```json
{
  ...
  "id" : "vs-pico",
  "url" : "http://fhir.awmf.org/awmf.ig/ValueSet/vs-pico",
  "version" : "0.2.0",
  "name" : "PICOVS",
