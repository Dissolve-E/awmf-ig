...
## ValueSet: Recommendation Synthesis Type 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.awmf.org/awmf.ig/ValueSet/vs-recommendation-synthesis-type | *Version*:0.2.0 |
| Draft as of 2026-01-29 | *Computable Name*:RecommendationSynthesisTypeVS |
...
```json
{
  ...
  "url" : "http://fhir.awmf.org/awmf.ig/ValueSet/vs-recommendation-synthesis-type",
  "version" : "0.2.0",
  "name" : "RecommendationSynthesisTypeVS",
