# Test: Release Type Wrong Code (Should Fail) - Dissolve-E: AWMF Guideline Registry v0.2.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Test: Release Type Wrong Code (Should Fail)**

## Example Composition: Test: Release Type Wrong Code (Should Fail)
...
```json
{
  ...
  "id" : "RR-TestTestInvRequireReleaseTypeIfReg-WrongCode-SHOULD-FAIL",
  "meta" : {
    "profile" : [
