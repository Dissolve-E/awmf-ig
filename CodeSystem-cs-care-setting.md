...
| Active as of 2026-03-19 | *Computable Name*:CareSetting |
...
```json
{
  ...
  {
    "code" : "other",
    "display" : "Other Setting",
    "definition" : "A different type of care setting",
    "_definition" : {
      "extension" : [{
        "extension" : [{
          "url" : "lang",
        ...
        {
          "url" : "content",
          "valueString" : "Andere Arten von Versorgungsbereichen"
        }],
        "url" : "http://hl7.org/fhir/StructureDefinition/translation"
      }]
    },
  ...
  },
  {
    "code" : "none",
    "display" : "None",
    "definition" : "No such care setting",
    "_definition" : {
      "extension" : [{
        "extension" : [{
          "url" : "lang",
        ...
        {
          "url" : "content",
          "valueString" : "Kein solcher Versorgungsbereich"
        }],
        "url" : "http://hl7.org/fhir/StructureDefinition/translation"
      }]
    },
