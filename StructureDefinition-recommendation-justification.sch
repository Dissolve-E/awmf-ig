...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:ArtifactAssessment/f:content/f:component</sch:title>
    <sch:rule context="f:ArtifactAssessment/f:content/f:component">
      ...
      <sch:assert test="count(f:freeToShare) &lt;= 1">freeToShare: maximum cardinality of 'freeToShare' is 1</sch:assert>
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:summary) &lt;= 1">summary: maximum cardinality of 'summary' is 1</sch:assert>
      <sch:assert test="count(f:type) &gt;= 1">type: minimum cardinality of 'type' is 1</sch:assert>
      <sch:assert test="count(f:type) &lt;= 1">type: maximum cardinality of 'type' is 1</sch:assert>
