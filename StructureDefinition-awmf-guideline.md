...
| Draft as of 2026-08-06 | *Computable Name*:AWMFGuideline |
...
* Examples for this Profile: [Composition/Demenzen](Composition-Demenzen.md), [Composition/DiffuseLargeBCellLymphomaGuideline](Composition-DiffuseLargeBCellLymphomaGuideline.md), [Composition/G-TestTestInvRequireOfficialIdentifier-NoOfficialId-SHOULD-FAIL](Composition-G-TestTestInvRequireOfficialIdentifier-NoOfficialId-SHOULD-FAIL.md), [Composition/G-TestTestInvRequireOfficialIdentifier-TwoOfficialId-SHOULD-FAIL](Composition-G-TestTestInvRequireOfficialIdentifier-TwoOfficialId-SHOULD-FAIL.md)... Show 5 more, [Composition/G-TestTestInvVersionMajorMinor-VersionInvalid-SHOULD-FAIL](Composition-G-TestTestInvVersionMajorMinor-VersionInvalid-SHOULD-FAIL.md), [Composition/G-TestTestInvVersionMajorMinor-VersionInvalid2-SHOULD-FAIL](Composition-G-TestTestInvVersionMajorMinor-VersionInvalid2-SHOULD-FAIL.md), [Composition/G-TestTestInvVersionMajorMinor-VersionPatch-SHOULD-FAIL](Composition-G-TestTestInvVersionMajorMinor-VersionPatch-SHOULD-FAIL.md), [Composition/GuidelineExample](Composition-GuidelineExample.md) and [Composition/NosokomialePneumonie](Composition-NosokomialePneumonie.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/awmf.ig|current/StructureDefinition/StructureDefinition-awmf-guideline.json)
