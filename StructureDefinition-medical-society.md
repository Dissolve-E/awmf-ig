...
| Draft as of 2026-08-06 | *Computable Name*:MedicalSociety |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/awmf.ig|current/StructureDefinition/StructureDefinition-medical-society.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.awmf.org/awmf.ig/StructureDefinition/ext-medical-subject-category"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.awmf.org/awmf.ig/StructureDefinition/ext-medical-subject"]
      }]
    },
    {
