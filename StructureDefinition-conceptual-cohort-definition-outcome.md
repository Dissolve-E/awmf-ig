...
| Draft as of 2026-08-06 | *Computable Name*:ConceptualCohortDefinitionOutcome |
...
* Examples for this Profile: [Group/Outcome-EventFreeSurvival](Group-Outcome-EventFreeSurvival.md), [Group/Outcome-OverallSurvival](Group-Outcome-OverallSurvival.md), [Group/Outcome-ProgressionFreeSurvival](Group-Outcome-ProgressionFreeSurvival.md), [Group/Outcome-Staging-NPV](Group-Outcome-Staging-NPV.md)... Show 6 more, [Group/Outcome-Staging-PPV](Group-Outcome-Staging-PPV.md), [Group/Outcome-Staging-Sensitivity](Group-Outcome-Staging-Sensitivity.md), [Group/Outcome-Staging-Specificity](Group-Outcome-Staging-Specificity.md), [Group/Outcome-Staging](Group-Outcome-Staging.md), [Group/PICOOutcomeSensitivityRec17](Group-PICOOutcomeSensitivityRec17.md) and [Group/PICOOutcomeSpecificityRec17](Group-PICOOutcomeSpecificityRec17.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/awmf.ig|current/StructureDefinition/StructureDefinition-conceptual-cohort-definition-outcome.json)
